...
class HomeController extends Controller
{
    ...
    public function index()
    {
        if (auth_permission_check('View Dashboard')) {
            ...
            return view('admin.dashboard.dashboard', compact('userCount','productCount'));
        } else {
            Auth::logout();
    ...
    public static function newOrderNotification()
    {
        ...
        $newProductInformation = $notifications->filter(function ($notification) {
            return $notification->type === "App\Notifications\ProductInformation";
        })->count();
    
        // $orderReminderCount = $notifications->filter(function ($notification) {
        //     return $notification->type === "App\Notifications\OrderReminder";
        // })->count();

     
        return compact('notifications', 'newProductInformation');
    }
