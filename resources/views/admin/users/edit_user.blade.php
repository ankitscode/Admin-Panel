...
<div class="row">
    <div class="col-lg-8">
        ...
        <form method="POST" action="{{route('admin.editUser',['id'=>$userDetails->id])}}" enctype="multipart/form-data">
            <div class="card-header py-3 d-flex justify-content-between align-items-center" style="background: none">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" name="is_active" type="checkbox" role="switch" id="is_active" value="{{ old('is_active', $userDetails->is_active) }}" @if (old('is_active', $userDetails->is_active)) checked @endif>
...
@include('admin.component.user_profile_image_update_modal')
@endsection
@section('script')
<script>
