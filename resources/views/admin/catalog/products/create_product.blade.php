                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto">
                            <div class="mx-auto">
                                <input class="dropify" type="file" id="profile-img-upload" name="image"
                                    accept="image/png, image/jpeg, image/jpg" name="image" form="storeProduct"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3 @error('category') is-invalid @enderror"
                                        name="category_id" id="category" data-choices data-choices-search-false required
                                        autofocus>
                                        <option autofocus value="">{{ __('main.select') }}</option>
